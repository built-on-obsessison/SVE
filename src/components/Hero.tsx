...
export default function Hero() {
  return (
    <section className="relative min-h-[95vh] flex items-center pt-20 overflow-hidden bg-transparent">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid lg:grid-cols-2 gap-12 lg:gap-8 items-center z-10 relative">
        <div className="flex flex-col items-start pt-12 lg:pt-0">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-display font-bold text-stone-50 leading-[1.05] tracking-tight mb-8"
          >
        ...
        >
          ...
          <motion.div
            ...
            className="absolute -bottom-8 -left-8 md:bottom-12 md:-left-12 glass-panel p-6 rounded-2xl max-w-[240px] shadow-2xl"
          >
